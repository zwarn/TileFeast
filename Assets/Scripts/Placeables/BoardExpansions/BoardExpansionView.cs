...
{
    public class BoardExpansionView : MonoBehaviour, IPlaceableView
    {
        private BoardExpansion _placeable;

        public void Bind(IPlaceable placeable) => _placeable = (BoardExpansion)placeable;
